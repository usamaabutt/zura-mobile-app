      ...
      >
        ...
        <View style={styles.cardView}>
          <ImageBackground
            ...
            resizeMode="cover"
          >
            <Text style={styles.card_header_text}>DAILY AFFIRMATION</Text>
            <Text style={styles.card_details_text}>
              Lorem ipsum dolor sit amet consectetur. Sed cursus platea
              sagittis.
            </Text>
          </ImageBackground>
        </View>
        ...
        <View style={styles.journal_details_container}>
          <View style={styles.journal_details_internal_container}>
            ...
            <View style={styles.journal_details_text_container}>
              <Text numberOfLines={1} style={styles.journal_details_text}>
                Lorem ipsum dolor sit amet consectetur.
              </Text>
              <Text numberOfLines={1} style={styles.journal_details_date}>
